...
static func help_lines() -> Array[String]:
    ...
    return [
        ...
        "  research - show research tree and status",
        "  research <id> - start researching (day only)",
        "  research cancel - cancel current research (refunds 50%)",
        "  trade - show trade rates and status",
        "  trade <amount> <resource> for <resource> - exchange resources (requires Market Lv3)",
