...
func _build_ui() -> void:
	custom_minimum_size = Vector2(DesignSystem.SIZE_PANEL_MD, 720)
...
func _build_milestone_section(title: String, color: Color, milestones: Array[Dictionary], suffix: String) -> void:
	...
	for milestone in milestones:
		...
		DesignSystem.style_label(title_label, "caption", ThemeColors.TEXT_DIM)
...
func _build_tips_section() -> void:
	var section := _create_section_panel("MILESTONE INFO", ThemeColors.SUCCESS)
	_content_vbox.add_child(section)
