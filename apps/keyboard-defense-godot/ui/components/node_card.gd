...
const TITLE_FONT_SIZE := 16  # DesignSystem.FONT_BODY
const LESSON_FONT_SIZE := 14 # DesignSystem.FONT_BODY_SMALL
const REWARD_FONT_SIZE := 12 # DesignSystem.FONT_CAPTION
