...
func _build_ui() -> void:
	...
	_poi_count_label.add_theme_font_size_override("font_size", 14)
	_poi_count_label.add_theme_color_override("font_color", ThemeColors.TEXT_DIM)
	...
	subtitle_row.add_child(toggle_spacer)
