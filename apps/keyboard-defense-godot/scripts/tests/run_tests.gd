...
const TESTS := [
	...
	"res://scripts/tests/test_asset_integrity.gd",
	"res://scripts/tests/test_progression_state.gd",
	"res://scripts/tests/test_scene_load.gd",
	"res://scripts/tests/test_battle_layout.gd",
	"res://scripts/tests/test_main_menu_layout.gd",
	"res://scripts/tests/test_kingdom_layout.gd",
	"res://scripts/tests/test_campaign_layout.gd",
	"res://scripts/tests/test_battle_overlays.gd",
	"res://scripts/tests/test_campaign_cards.gd",
	"res://scripts/tests/test_battle_hud_state.gd",
