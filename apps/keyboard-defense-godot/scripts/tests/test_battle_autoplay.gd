...
func _wire_battle_nodes(battle, progression, game_controller) -> void:
	...
	battle.word_label = battle.get_node("PlayField/DrillHud/TypingReadout/WordLabel")
	battle.typed_label = battle.get_node("PlayField/DrillHud/TypingReadout/TypedLabel")
