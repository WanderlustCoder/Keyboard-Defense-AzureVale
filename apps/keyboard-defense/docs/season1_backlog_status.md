...
| 36 | Enemy & Wave Design | Implement evacuation event requiring long-form typing to rescue civilians. | Done | Transport + banner + lane reservation to avoid conflicts (docs/status/2025-12-09_evacuation_events_slice3.md) |
