...
Add new lists alongside the lesson progression (home row → top row → bottom row → numbers → punctuation/mixed) and run `npm run lint:wordlists:strict` before committing. Current seeds include:

- `lesson_home_row.json`
- `lesson_top_row.json`
- `lesson_bottom_row.json`
