...
- `2025-12-27_collapsible_menus_plan.md` - Plan for collapsible options sections with persisted state, quick controls, and reduced-motion-safe toggles.
- `2025-12-27_ui_navigation_plan.md` - Plan for UI quick-access/navigation (sticky quick bar, mini-nav pills, responsive layout, condensed cards).
...
- `2025-12-27_accessibility_shortcuts_plan.md` - Plan for pinned accessibility preset strip, keycap shortcuts, quick test overlay, and safe persistence/ARIA guards.
- `2025-12-27_battle_log_summary_plan.md` - Plan for battle-log summary strip, filters, pins, and virtualized log with key event focus.
- `2025-12-27_tutorial_surface_refresh_plan.md` - Plan for compact tutorial hints, docked steps, progress capsule, and reduced-motion-safe messaging.
