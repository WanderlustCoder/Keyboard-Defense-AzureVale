...
- Regenerated `docs/hud_gallery.md` and `artifacts/summaries/ui-snapshot-gallery.json` to remove duplicate rows and list combined sources; Codex dashboard/portal now render all HUD shots (no ellipsis when <=10).
