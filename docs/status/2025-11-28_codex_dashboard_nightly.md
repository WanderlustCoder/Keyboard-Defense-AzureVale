...
- The nightly job now writes a brief step summary (portal snapshot + starfield telemetry) to `$GITHUB_STEP_SUMMARY` so operators can skim results without downloading artifacts.
